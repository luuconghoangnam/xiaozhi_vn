...
class ResourceFinder:
    ...
    def get_user_data_dir(self, create: bool = True) -> Path:
        ...
        # Override user data dir to keep everything inside a chosen folder (e.g. D:\xiaozhi\_data)
        # This prevents scattering caches under %LOCALAPPDATA%.
        override = os.getenv("XIAOZHI_USER_DATA_DIR")
        if override:
            p = Path(override)
            # If user explicitly sets the dir, always ensure it exists.
            try:
