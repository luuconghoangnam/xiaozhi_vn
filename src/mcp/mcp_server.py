...
class McpServer:
    ...
    def add_common_tools(self):
        ...
        # Web search tools
        from src.mcp.tools.web_search import get_web_search_manager
        web_search_manager = get_web_search_manager()
        web_search_manager.init_tools(self.add_tool, PropertyList, Property, PropertyType)

        # Local knowledge tools
        from src.mcp.tools.knowledge import get_knowledge_manager
        knowledge_manager = get_knowledge_manager()
        knowledge_manager.init_tools(self.add_tool, PropertyList, Property, PropertyType)
        ...
        # 添加收音机工具 (Vietnamese Radio)
        from src.mcp.tools.radio import get_radio_tools_manager
        radio_manager = get_radio_tools_manager()
        radio_manager.init_tools(self.add_tool, PropertyList, Property, PropertyType)

        # 添加 YouTube 工具
        from src.mcp.tools.youtube import get_youtube_tools_manager
        youtube_manager = get_youtube_tools_manager()
        youtube_manager.init_tools(self.add_tool, PropertyList, Property, PropertyType)
