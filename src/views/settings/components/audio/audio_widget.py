...
class AudioWidget(QWidget):
    ...
    def _get_ui_controls(self):
        ...
        # FIX: Ensure combo boxes don't push buttons out of the window
        from PyQt5.QtWidgets import QSizePolicy
        for name in ["input_device_combo", "output_device_combo"]:
            if self.ui_controls[name]:
                self.ui_controls[name].setSizePolicy(QSizePolicy.Ignored, QSizePolicy.Fixed)
                self.ui_controls[name].setMinimumWidth(150)
    ...
    def _scan_devices(self):
        ...
        try:
            ...
            self._append_status(
                f"Quét xong: Tìm thấy {len(self.input_devices)} thiết bị đầu vào (Mic), {len(self.output_devices)} thiết bị đầu ra (Loa)"
            )
    ...
    def _reset_input_test_ui(self):
        ...
        self.ui_controls["test_input_btn"].setText("Thử Mic")
    ...
    def _reset_output_test_ui(self):
        ...
        self.ui_controls["test_output_btn"].setText("Thử Loa")
