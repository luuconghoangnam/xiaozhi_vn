"""
Module tray hệ thống: icon/menus/trạng thái.
"""
...
class SystemTray(QObject):
    ...
    def _setup_tray(self):
        ...
        try:
            ...
            if not QSystemTrayIcon.isSystemTrayAvailable():
                self.logger.warning("Hệ thống không hỗ trợ tray")
                return
            ...
            # 显示系统托盘图标
            self.tray_icon.show()
            self.logger.info("Đã khởi tạo tray")
    ...
    def _create_tray_menu(self):
        ...
        # 添加Mở cửa sổ菜单项
        show_action = QAction("Mở cửa sổ", self.parent_widget)
        ...
        # 添加设置菜单项
        settings_action = QAction("Cài đặt", self.parent_widget)
        ...
        # 添加退出菜单项
        quit_action = QAction("Thoát", self.parent_widget)
    ...
    def update_status(self, status: str, connected: bool = True):
        ...
        try:
            ...
            # 设置提示文本
            tooltip = f"Trợ lý Xiaozhi - {status}"
    ...
    def _get_status_color(self, status: str, connected: bool) -> QColor:
        ...
        if "错误" in status:
            ...
            return QColor(0, 180, 0)  # 绿色 - Sẵn sàng/已启动状态
