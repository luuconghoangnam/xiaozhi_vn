...
class WebsocketProtocol(Protocol):
    def __init__(self):
        ...
        self._handling_connection_loss = False
        ...
        # Reconnect is driven by Application.connect_protocol() when the user
        # wakes/starts listening.  Keeping the socket in an infinite reconnect
        # loop creates duplicate sessions after idle server timeouts.
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            hello_message = {
                ...
                "llm": {
                    "system_prompt": self.config.get_config("SYSTEM_OPTIONS.SYSTEM_PROMPT", "")
                },
            }
